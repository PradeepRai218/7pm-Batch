...
//  console.log(allIds);
  ...
  return (
    <section className="w-full">
      ...
      <div
        className={`bg-gray-50 px-2 py-5 max-w-[1220px] duration-[1s] mx-auto mt-10 ${
          ...
          <div className="flex item-center justify-between bg-slate-100 py-3 px-4 rounded-t-md border border-slate-400">
            ...
            <div className="flex justify-between ">
              <div
                ...
                className="cursor-pointer text-white mx-3 rounded-[50%] w-[40px] h-[40px] flex items-center justify-center bg-blue-700  border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                {activeFilter ? (
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    {data.length >= 1 ? (
                      ...
                      <tr>
                        <td colSpan={6}>No Color Found</td>
                      </tr>
                    )}
                  </tbody>
                </table>
