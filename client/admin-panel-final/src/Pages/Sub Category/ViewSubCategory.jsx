...
export default function ViewCategory() {
  ...
  return (
    <section className="w-full">
      ...
      <div
        className={`rounded-lg border border-gray-300 px-5 py-5 max-w-[1220px] mx-auto mt-10 ${
          activeFilter ? "hidden" : "block"
        }`}
      >
          ...
          <div className="flex item-center justify-between bg-slate-100 py-3 px-4 rounded-t-md border border-slate-400">
            ...
            <div className="flex justify-between ">
              <div
                ...
                className="cursor-pointer text-[white] mx-3 rounded-[50%] w-[40px] h-[40px]  mx-3 rounded-[50%] w-[40px] h-[40px] flex items-center justify-center  text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                {activeFilter ? (
                    ...
                    {data.map((object, index) => {
                      return (
                        <tr class="bg-white  dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                          ...
                          >
                            <div class="py-4">{object.parentCategory.categoryName}</div>
                          </td>
                          <td class=" py-4">{object.subcategoryName}</td>

                          <td class=" py-4">
                            <img
                              class="w-10 h-10 rounded-full"
                              src={path+object.subcategoryImage}
                              alt="Jese image"
                            />
                          </td>
                          <td class=" py-4"> {object.subcategoryOrder} </td>
                          <td class=" py-4">
                            <button
                              type="button"
