        ...
        <header className="w-full font-poppins sticky top-0 z-50 bg-white text-black">
            ...
            <div className="border-b border-gray-300 py-2">
                <div className="max-w-[1320px] mx-auto flex justify-between items-center px-4">
                    <p className="text-sm text-black">Contact us 24/7 : +91-98745612330 / furnitureinfo@gmail.com</p>
                    <Link
                        href="/Login-Register"
            ...
            <div className="border-b border-gray-300 bg-white py-4">
                <div className="max-w-[1320px] mx-auto flex justify-between items-center gap-4 px-4">
                    ...
                    <div className="w-[150px]">
                        <img src="https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/company-profile/logo/cccfbdab-3bec-439f-88b9-5694698cd302-1670132652.png" alt="Logo" className="w-full" />
                    </div>
                    ...
                    <div className="flex items-center gap-3">
...

                        {
                            ...
                            <div className="fixed top-0 right-0 w-[500px] h-full bg-white shadow-2xl border-l border-gray-200 z-50 p-6 overflow-y-auto duration-1000">
                                ...
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <button onClick={handleclose} className="text-gray-500 hover:text-[#C09578] text-2xl font-bold cursor-pointer">&times;</button>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between border-b pb-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            />
                                            <div>
                                                <h3 className="text-lg font-medium text-gray-800">Wooden Chair</h3>
                                                <p className="text-sm text-gray-500">Qty: 2</p>
                                            </div>
                                        </div>
                                        <span className="text-[#C09578] font-semibold text-lg">$120</span>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between border-b pb-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            />
                                            <div>
                                                <h3 className="text-lg font-medium text-gray-800">Sofa Set</h3>
                                                <p className="text-sm text-gray-500">Qty: 1</p>
                                            </div>
                                        </div>
                                        <span className="text-[#b76e79] font-semibold text-lg">$250</span>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 border-t pt-4">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <span className="text-xl font-bold text-[#b76e79]">$370</span>
                                    </div>
                        ...
                        <button onClick={handleclick} className="border border-gray-300 rounded-full px-4 py-2 flex items-center gap-2 cursor-pointer hover:border-[#b76e79] hover:text-[#b76e79] transition">
                ...
                <div className="max-w-[1320px] mx-auto flex justify-center items-center">
                    <ul className="flex items-center gap-10 text-[15px] font-bold text-black ">
                        ...
                        <li className="relative group">
                            <a href="#" className="flex items-center gap-1 hover:text-[#b76e79]">
                                LIVING <FaAngleDown />
                            </a>
                            ...
                            <div className="absolute top-full left-0 hidden group-hover:flex bg-white shadow-lg border border-gray-300 p-4 gap-10 min-w-max">
                                <ul className="space-y-2 text-black">
                                    ...
                                    <li>
                                        <Link href="/Product-Listing-page" className="hover:text-[#b76e79] block">
                                            Living Room
                                        </Link>
                                    </li>
                                    <li>
                                ...
                                <ul className="space-y-2 text-black">
                                    <li className="text-[16px] text-[#b76e79]">Living Storage/collections</li>
                                    <li>
                                        <a href="#" className="hover:text-[#b76e79] block">
                                            Prayer Units
                                        </a>
                        ...
                        <li className="relative group">
                            ...
                            <div className="absolute top-full left-0 hidden group-hover:block bg-white shadow-lg border border-gray-300 p-4 w-48">
                                <ul className="space-y-2 text-black">
                                    ...
                                    <li>
                                        <Link href="/about-us" className="hover:text-[#b76e79] block">
                                            About Us
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href="/Shoping-Cart" className="hover:text-[#b76e79] block">
                                            Cart
                                        </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <Link href="/FAQ-Section" className="hover:text-[#b76e79] block">
                                            FAQ
                                        </Link>
                                    </li>
                                </ul>
                        ...
                        <li>
                            <Link href="/Contact-us" className="hover:text-[#b76e79] transition">
                                CONTACT US
                            </Link>
                        </li>
                    </ul>
